                ...
                <div class="footer-content">
                    ...
                    <ul class="socials">
                        ...
                        <?php if (!empty($fauzanredux['social-network-url']['Twitter'])): ?>
                            <li><a href="<?php echo $fauzanredux['social-network-url']['Twitter']; ?>"
                                   target="_blank"><i
                                            class="fa fa-twitter"></i></a></li>
                        <?php endif; ?>

                        <?php if (!empty($fauzanredux['social-network-url']['Google Plus'])): ?>
                            <li><a href="<?php echo $fauzanredux['social-network-url']['Google Plus']; ?>"
                                   target="_blank"><i
                                            class="fa fa-google-plus"></i></a></li>
                        <?php endif; ?>

                        <?php if (!empty($fauzanredux['social-network-url']['Youtube'])): ?>
                            <li><a href="<?php echo $fauzanredux['social-network-url']['Youtube']; ?>"
                                   target="_blank"><i
                        ...
                        <?php if (!empty($fauzanredux['social-network-url']['Instagram'])): ?>
                            <li>
                                <a href="https://www.instagram.com/<?php echo $fauzanredux['social-network-url']['Instagram']; ?>"
